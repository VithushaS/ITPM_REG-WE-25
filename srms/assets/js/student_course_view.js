$(document).ready(function () {
    ...
    function loaddata() {
        ...
        $.ajax({
            url: "controller/student_course_view_controller.php",
            type: "POST",
            cache: false,
            data:{
                mode:'view_data'
     ...
     $('#show-add').click(function () {
        ...
        $('#add_db').click(function () {
            ...
            // Conditions filled
            if (form_data['module_name'] !='' && form_data['title'] !='') {
        ...
        $('#add_cancel').click(function () {
            ...
            $("body").on("click", ".edit", function () {
                ...
                $('#update_db').click(function () {
                    ...
                    form_data['edit_title'] = $("#edit_title").val();
