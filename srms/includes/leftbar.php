<div class="left-sidebar bg-black-300 box-shadow ">
  ...
  <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Subject</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="create-subject.php"><i class="fa fa-bars"></i> <span>Add Subject</span></a></li>
                                            <li><a href="manage-subjects.php"><i class="fa fa fa-server"></i> <span>Manage Subject</span></a></li>
       ...
       <li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>Employee</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="addemp.php"><i class="fa fa-bars"></i> <span>Add Employee</span></a></li>
                                            <li><a href="viewemp.php"><i class="fa fa fa-server"></i> <span>Employee manage</span></a></li>
